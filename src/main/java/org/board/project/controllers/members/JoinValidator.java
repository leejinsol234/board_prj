...
import org.board.project.commons.validators.MobileValidator;
import org.board.project.commons.validators.PasswordValidator;
...
public class JoinValidator implements Validator, PasswordValidator, MobileValidator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (email != null && !email.isBlank() && repository.exists(email)) {
            errors.rejectValue("email", "Duplicated"); //rejectValue: 특정 필드에 한정된 에러
        }
